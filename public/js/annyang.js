  ...
  annyang = {
    ...
    */
    addCommandsWithDynamicText: function (commands) {
      console.log("Found command", commands);
    ...
    addCommandDynamically: function (command) {
      if (typeof command.callback === "function") {
        registerCommand(commandToRegExp(command.phrase), command.callback, command.phrase);
      } else {
        console.log('Can not register command: %c' + command.phrase, 'color:red;font-size:20px;');
      }
    },
    /**
